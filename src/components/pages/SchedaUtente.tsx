...
export const SchedaUtente = () => {
    ...
    const isReadOnly: boolean = section !== Sections.MODIFICA_UTENTE
    const isDisabled: boolean =
        isEqual(form.watch(), utente) || isLoading || !isValid
    ...
    return (
        <>
            <form onSubmit={form.handleSubmit(() => setShowModal(true))}>
            ...
            <CustomModal
                ...
                onConfirm={async (): Promise<void> =>
                    await handleSalva(form.getValues())
                }
            ></CustomModal>
        </>
    )
